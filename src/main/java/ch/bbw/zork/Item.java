...
public class Item {
    ...
    public Item(String name, String description) { // Konstruktor der Public Class Item wird verwendet wenn man die Klasse aufruft | z.B Item schlüssel = new Item("Schlüssel", "Ein alter rostiger Schlüssel"); | "Schlüssel" wird in name gespeichert und man muss halt sagen name ist ein string
    ...
    public String toString() { // öffentliche toString Methode, die ein String zurückgibt
        return name + ": " + description; // return den namen: beschreibung
